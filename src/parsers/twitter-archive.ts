    ...
    tweet: {
      ...
      extended_entities: {
        media: [
          {
            expanded_url:
              'https://twitter.com/schmeaton/status/1267477790099755012/photo/1',
            url: 'https://t.co/meTdcjoFMQ',
            media_url:
              'http://pbs.twimg.com/tweet_video_thumb/EZb8VGVX0AMLxyH.jpg',
            ...
            media_url_https:
              'https://pbs.twimg.com/tweet_video_thumb/EZb8VGVX0AMLxyH.jpg',
            type: 'animated_gif',
